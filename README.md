# Social Network with authentication and full CRUD functionality
...
- the addition of a section in the user's profile for all gigs a user has a "going" status for
